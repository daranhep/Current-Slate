...
class FooterLoginView: UIView {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        self.addBorder(edges: [.Top], colour: UIColor.whiteColor().colorWithAlphaComponent(0.20))
    ...
    func addBorder(edges edges: UIRectEdge, colour: UIColor = UIColor.whiteColor(), thickness: CGFloat = 0.5) -> [UIView] {
